    ...
    <div>
      ...
      <a-table ref="TableInfo"
        ...
        <template slot="operation" slot-scope="text, record">
          <a-icon type="edit" v-hasPermission="'book:update'" theme="twoTone" twoToneColor="#4a9ff5" @click="edit(record)" title="修改书籍"></a-icon>
          <a-badge v-hasNoPermission="'book:update'" status="warning" text="无权限"></a-badge>
          <a-divider type="vertical" />
          <a-icon type="delete" theme="twoTone" v-hasPermission="'book:delete'" @click="deleteOne(record.id)" title="删除"/>
        </template>
      </a-table>
    </div>
    <!-- 新增书籍 -->
